...
API_ID = int(environ.get('24133583', ''))
API_HASH = environ.get('f62ea6fb79542574852095f658c230dc', '')
BOT_TOKEN = environ.get('7414697694:AAEt9SlCAQsJj42u0r2BQomgUFMunhlgE70', "")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('5762124697', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002139357839', '').split()]
...
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(-1001974701403) else None
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://taxafe7395:Zn4iVzeiw5ZsGAoA@cluster0.1d2gx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', "")
